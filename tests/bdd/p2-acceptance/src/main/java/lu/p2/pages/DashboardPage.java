...
public class DashboardPage {
    ...
    public void checkDonation(final DonateRecord donateRecord) {
        finders.waitById("donations-tab");
        finders.clickById("donations-tab");
        finders.findByText("td", donateRecord.getCharityName());
        finders.findByText("td", donateRecord.getAmount());
        finders.waitByText("a", "Download");
        assertThat(finders.findByClassName("text-break").getText().contains(donateRecord.getMessage()), is(true));
