...
public class TicketPageTest {
    ...
    public void Can_check_my_ticket() {
        ...
        given(assignToWE.findElement(Bys.text("strong", ""))).willReturn(mock(WebElement.class));
    ...
    public void Can_check_ticket_is_new() {
        ...
        given(parentWE.findElement(Bys.text("small", "Assigned to: "))).willReturn(mock(WebElement.class));
