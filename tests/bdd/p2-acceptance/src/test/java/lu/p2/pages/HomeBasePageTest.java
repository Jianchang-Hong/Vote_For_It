...
public class HomeBasePageTest {
    ...
    public void Can_goto_an_ongoing_event() {
        ...
        given(parentCardWE.findElement(Bys.tagName("div"))).willReturn(bWE);
        ...
        given(parentCardWE.findElement(Bys.parentClassName("div", "event-card"))).willReturn(webElement);
        given(webElement.findElement(Bys.attribute("a", "class", "stretched-link"))).willReturn(btnWE);
